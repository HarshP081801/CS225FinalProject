...
class AVLTree
{
  ...
  public:
    ...
    /**
     * Gets the level-order traversal of an AVL tree's keys.
     */
    std::vector<K> getLevelorderTraversal();
    /**
    ...
    */
    ...
    void BFS_Traversal(AVLTree<int, string> tree, string inputFile, string outputFile);
  ...
  private:
     ...
     * Gets the level-order traversal of an AVL tree's keys.
     */
    void getLevelorderTraversal(const Node* subRoot, std::vector<K>& traversal);
    /**
