 ...
 * 
 * We added our own algorithms as well
 */
#pragma once
...
public:
    ...
    //functions we as a group added
    void fillGraph(const string& Verticies, const string& Edges);
    void dijkstra(Vertex source, string fileName);
...
private:
    ...
    //Our Private Helper Functions
    int minDistance(vector<int> dist,  vector<bool> spt);
    bool isClose(vector<double> newPR, vector<double> oldPR, double e);

    //Our private variables
    typedef long long ll;
    typedef unsigned long long ull;
    vector<vector<int>> edgeMatrix;
    vector<pair<Vertex, int>> edgeMatrixKey;
